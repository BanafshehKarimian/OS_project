...
AddrSpace::AddrSpace(OpenFile *executable)
{
    ...
    if ((noffH.noffMagic != NOFFMAGIC) && 
    	...
    	SwapHeader(&noffH);
    ASSERT(noffH.noffMagic == NOFFMAGIC);/////////////////////////////////////////bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
...
// and the stack segment
    bzero((machine->mainMemory+totalPagesCount*PageSize), size);///////////////////////////////////////bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
